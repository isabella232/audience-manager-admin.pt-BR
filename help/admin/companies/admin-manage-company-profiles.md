...
Use a [!UICONTROL Companies] página na ferramenta Admin Audience Manager para criar uma nova empresa.

<!-- t_create_company.xml -->

>[!NOTE]
>
>É necessário ter a **[!UICONTROL DEXADMIN]** função para criar novas empresas.
...
1. Preencha os campos:
   ...
   * **[!UICONTROL Subdomain]**: (Obrigatório) Especifique o subdomínio empresa. O texto inserido é o que aparece como subdomínio da chamada do evento. Isso não pode ser mudado. Deve ser uma string de caracteres [!DNL URL]válidos.
   ...
   * **[!UICONTROL Account Types]**: Especifique o conjunto completo de tipos de conta para esta empresa. Nenhum tipo de conta é mutuamente exclusivo com qualquer outro tipo.
      ...
      * **[!UICONTROL MMP]**: Especifique se a empresa foi habilitada para usar os [!UICONTROL Master Marketing Profile] ([!UICONTROL MMP]) recursos. O [!UICONTROL MMP] permite que as audiências sejam compartilhadas através do Experience Cloud usando um [!UICONTROL Experience Cloud ID] ([!DNL MCID]) que é atribuído a cada visitante e, em seguida, usado pelo Audience Manager. Se você selecionar esse tipo de conta, a conta também [!UICONTROL Experience Cloud ID Service] será selecionada automaticamente.

         Para obter mais informações, consulte [Audiência Services - Perfil](https://marketing.adobe.com/resources/help/en_US/mcloud/audience_library.html)de marketing Principal.
   ...
   * **[!UICONTROL Visitor ID Service]**: Especifique se a empresa foi habilitada para usar o [!UICONTROL Experience Cloud Visitor ID Service].
      ...
      O [!UICONTROL Experience Cloud Visitor ID Service] fornece uma ID de visitante universal nas soluções de Experience Cloud. For more information, see the [Experience Cloud Visitor ID Service user guide](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-overview.html).

   * **[!UICONTROL Agency]**: Especifique que a empresa terá uma [!UICONTROL Agency] conta.



1. Clique em **[!UICONTROL Create]**. Continue com as instruções em [Editar uma Perfil](../companies/admin-manage-company-profiles.md#edit-company-profile)de Empresa.
...
## Excluir uma Perfil de Empresa {#delete-company-profile}
...
>[!NOTE]
>
>É necessário ter a [!UICONTROL DEXADMIN] função para excluir empresas existentes.
